      ...
      body: Container(
        ...
        child: ListView(
          children: <Widget>[
            ...
            Row(
              children: <Widget>[
                Text('菜品类型:',style: TextStyle(color: Colors.black,fontSize: 30)),
            ...
            Row(
              children: <Widget>[
                ...
                Expanded(
                  flex: 1,
                  child:Text('是否展示:',style: TextStyle(color: Colors.black,fontSize: 30)),
                ),
            ...
            onPressed: (){
                // 新增
                if(isAdd) {
                    var item = Dish(name: nameCtrl.text ?? '',price: priceCtrl.text ?? '',isShow: isShow);
    ...
    for (Category item in categories) {
      items.add(
        new DropdownMenuItem<String>(
          child:Text('${item.name}',style: TextStyle(fontSize: 30),),
          value: item.objectId,
        )
      );
    }
